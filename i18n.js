/* CleanCore Decon — i18n: language selector, browser auto-detect + redirect.
   URL scheme: English at root (/), Spanish under /es/ mirroring the same paths. */
(function () {
  var LOCALES = [
  ...
  /* Auto-redirect only from the default (English) URLs, so an explicit /es/ link
